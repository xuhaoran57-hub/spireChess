...
def main() -> int:
    ...
    identity_passed = (
        len(items) == 9
        and all(item["kind"] == "Spell" for item in items)
        and all(1 <= item["tier"] <= 5 for item in items)
    ...
    batch_five = catalog_entries(BATCH_FIVE_CATALOG_PATH)
    ...
    for item in items:
        ...
        passed = (
            ...
            and item["artId"] not in batch_five
        ...
        catalog_results.append(
            {
                ...
                "absentFromBatchFive": item["artId"] not in batch_five,
    ...
    catalog_passed = (
        catalog_passed
        and len(isolated) == 86
        and set(batch_five).issubset(isolated)
    )
    checks.append(
        {
            ...
            "details": {
                ...
                "containsAllPreviousCatalogEntries":
                    set(batch_five).issubset(isolated),
