...
def main() -> int:
    ...
    identity_passed = (
        ...
        and all(item["tier"] == 5 for item in items)
    ...
    batch_four = catalog_entries(BATCH_FOUR_CATALOG_PATH)
    ...
    for item in items:
        ...
        passed = (
            ...
            and item["artId"] not in batch_four
        ...
        catalog_results.append(
            {
                ...
                "absentFromBatchFour": item["artId"] not in batch_four,
    ...
    catalog_passed = (
        catalog_passed
        and len(isolated) == 77
        and set(batch_four).issubset(isolated)
    )
    checks.append(
        {
            ...
            "details": {
                ...
                "containsAllPreviousCatalogEntries":
                    set(batch_four).issubset(isolated),
