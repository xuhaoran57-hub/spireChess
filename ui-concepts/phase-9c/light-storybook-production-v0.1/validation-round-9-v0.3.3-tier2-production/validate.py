...
def main() -> int:
    ...
    identity_passed = (
        ...
        and all(item["tier"] == 2 for item in items)
    ...
    batch_one = catalog_entries(BATCH_ONE_CATALOG_PATH)
    ...
    for item in items:
        ...
        passed = (
            ...
            and item["artId"] not in batch_one
        ...
        catalog_results.append(
            {
                ...
                "absentFromBatchOne": item["artId"] not in batch_one,
    ...
    catalog_passed = (
        catalog_passed
        and len(isolated) == 53
        and BATCH_ONE_ART_IDS.issubset(isolated)
    )
    checks.append(
        {
            ...
            "details": {
                ...
                "containsAllBatchOneArtIds":
                    BATCH_ONE_ART_IDS.issubset(isolated),
