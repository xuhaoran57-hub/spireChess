...
- Generated source: `call_lkQIkE5CMZEUJtzk6jm6mtN9.png`
- Final path: `masters/spells/delayed-supply.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; chest, hourglass and pouch are readable; no visible text, UI, frame or watermark; focal content remains clear of the trim edge.
...
- Generated source: `call_ICsVOazdGRJnI9cXFkCNQpZW.png`
- Final path: `masters/spells/temporary-ward.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; ward, figurine and leaf read as one clear cluster; no visible text, UI, frame or watermark.
...
- Initial source: `call_cZzhbkVWu4KITft7rjoFJShs.png`
- Final generated source: `call_RH3paxNPhh6Vp6JkJ9PSLCMR.png`
- Final path: `masters/spells/precise-training.png`
- Revision: one controlled composition edit because the spear shaft originally exited the right trim edge.
- Check: horizontal approximately 5:4; RGB; complete single spear is visible with breathing room; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no readable marks, no logo, no watermark, no signature; exactly one main dummy and one spear
Avoid: target rings with numerals, glossy digital effects, photorealism, anime, cute mascot style, neon particles, duplicated weapons, busy armory clutter
```

Final controlled revision prompt:

```text
Controlled composition correction only. Preserve the existing Wandering Storybook watercolor-and-colored-ink scene, dummy, canvas backdrop, palette, lighting, textures, and all object identities. Shorten and reposition the single practice spear so the entire spear, including its butt end, is visibly contained inside the central 80% safe area with clear breathing room from every edge. Keep its tip striking the central wood knot. Do not add or remove any other objects. No text, letters, numbers, symbols, logo, watermark, signature, card frame, or UI.
```

### `thickhide_potion`

- Generated source: `call_vy4ZrNOWqXyM6eMRHSOnAgJ8.png`
- Final path: `masters/spells/thickhide-potion.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; one bottle and reinforced pad are distinct at thumbnail scale; no visible text, UI, frame or watermark.
...
- Initial source: `call_exh7ED6qwdDGo9Sam6ylg3nU.png`
- Final generated source: `call_ElEvTx6Y0diEO8Eh82SAStxE.png`
- Final path: `masters/spells/warband-forging.png`
- Revision: one controlled framing edit because the hammer and anvil originally extended outside the central safe area.
- Check: horizontal approximately 5:4; RGB; one complete hammer, anvil and blank badge are visible; exactly four tokens remain, with one glowing; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no readable runes, no heraldic writing, no logo, no watermark, no signature; exactly one anvil, one hammer and one central clan badge; no characters
Avoid: glowing alphabetic glyphs, fantasy text, glossy digital effects, photorealism, anime, cute mascot style, neon sparks, duplicated tools, busy industrial machinery
```

Final controlled revision prompt:

```text
Controlled framing correction only. Preserve the existing Wandering Storybook watercolor-and-ink forge scene, anvil, blank glowing shield badge, four wooden ancestry tokens with only one glowing, palette, lighting, and texture. Scale the focal object cluster down and recompose it so the complete anvil and the complete single hammer, including the hammer handle end, are fully visible inside the central 80% safe area with generous ivory-painted breathing room on all sides. Keep exactly four tokens and exactly one glowing token. Do not add or remove any other focal objects. No text, letters, numbers, readable runes, symbols, logo, watermark, signature, card frame, or UI.
```

### `starlight_rebate`

- Generated source: `call_HBMEotFcolREO1CUNik91Kaw.png`
- Final path: `masters/spells/starlight-rebate.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; exactly two ribbon loops and three coins are readily countable; no visible text, UI, frame or watermark.
...
- Generated source: `call_AfWYs9C3UrtcuvsjjlNr7icZ.png`
- Final path: `masters/spells/prototype-copy.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; exactly two matching figurines are clear; the parchment is blank; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no diagrams, no readable writing, no logo, no watermark, no signature; exactly two matching figurines total, one original and one copy; no character
Avoid: photocopier imagery, computer interfaces, glossy digital effects, photorealism, anime, cute mascot style, neon holograms, extra miniatures, busy machinery
```

### `bloodline_awakening`

- Generated source: `call_9Yez4bxB13PRskOaAL9wcBcL.png`
- Final path: `masters/spells/bloodline-awakening.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; one central totem and four matching figurines are complete and countable; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no readable runes or writing, no logo, no watermark, no signature; exactly one central totem and exactly four matching figurines; no living characters
Avoid: family-tree diagrams, DNA imagery, blood gore, readable symbols, glossy digital effects, photorealism, anime, cute mascot style, neon magic, duplicated totems, excessive particles
```

### `fate_reforging`

- Generated source: `call_KlWsvNPszIrBEN9J23xyDM9O.png`
- Final path: `masters/spells/fate-reforging.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; the single half-wood/half-gold figurine and shuttle remain central and legible; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no readable runes or writing, no logo, no watermark, no signature; exactly one figurine, one anvil and one shuttle; no living character
Avoid: spinning-wheel clutter, written prophecy, hourglasses, glossy digital effects, photorealism, anime, cute mascot style, neon lightning, duplicate minions, excessive particles
```

### `army_ascension`

- Generated source: `call_8mwdt4jjd67nI90qdzoKj5eM.png`
- Final path: `masters/spells/army-ascension.png`
- Revision: none
- Check: horizontal approximately 5:4; RGB; blank banner and exactly five matching figurines are readable; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no emblems, no readable writing, no logo, no watermark, no signature; exactly one banner and exactly five matching figurines; no living characters
Avoid: military propaganda lettering, heraldic text, photorealism, glossy digital effects, anime, cute mascot style, neon beams, extra troops, crowded battlefield, weapons pointing out of frame
```

### `legendary_recruitment`

- Initial source: `call_SIzVPoBAypnFfIIYW9iW3QLm.png`
- Final generated source: `call_bMDOqzlR318hKLK1jsTvOfS3.png`
- Final path: `masters/spells/legendary-recruitment.png`
- Revision: one controlled framing edit because the left and right doorway edges originally sat outside the central safe area.
- Check: horizontal approximately 5:4; RGB; exactly four complete doorways remain, three dark and one gold; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no readable runes or writing, no logo, no watermark, no signature; exactly four doorways total, three dark choices and one gold bonus; no living characters
Avoid: card-selection interface, literal trading cards, written tier marks, Roman numerals, glossy digital effects, photorealism, anime, cute mascot style, neon portals, extra silhouettes, crowded throne room
```

Final controlled revision prompt:

```text
Controlled framing correction only. Preserve the existing Wandering Storybook watercolor-and-ink pavilion, palette, lighting, tabletop, and exactly four recruitment doorways with the same three dark heroic figurines plus one smaller golden bonus figurine. Scale and center the four-doorway focal group so every complete arch, base, and figurine fits comfortably inside the central 80% safe area, with visible breathing room on left and right. Keep the count, identities, ordering, and relative golden emphasis unchanged. Do not add or remove focal objects. No text, letters, numbers, readable runes, logo, watermark, signature, card frame, or UI.
```

### `triple_discovery_reward`

- Initial source: `call_CujmiLFWm4TitnmIP5V6hzkA.png`
- Final generated source: `call_UQi8kEAZ4kweumHmztyMqdZc.png`
- Final path: `masters/spells/triple-discovery-reward.png`
- Revision: one controlled framing edit because the lower figurine originally touched the bottom trim edge.
- Check: horizontal approximately 5:4; RGB; exactly three figurines and three outgoing choice paths remain complete and countable; no visible text, UI, frame or watermark.
...
Constraints: no card border, no UI, no labels, no text, no letters, no numbers, no readable runes or writing, no logo, no watermark, no signature; exactly three matching figurines, one prism and exactly three outgoing light paths; no living characters
Avoid: literal trading cards, slot-machine imagery, written choice labels, glossy digital effects, photorealism, anime, cute mascot style, neon rainbow, extra figures, excessive particles
```

Final controlled revision prompt:

```text
Controlled framing correction only. Preserve the existing Wandering Storybook watercolor-and-ink divination table, palette, exactly three matching wooden figurines, one central golden prism, three incoming amber streams, and exactly three colored outgoing discovery paths with their three distinct nonverbal objects. Move the lower figurine upward and slightly scale the complete focal arrangement down so every figurine base, prism, and all three choice objects are fully contained inside the central 80% safe area with visible breathing room from every edge. Keep counts and identities unchanged. Do not add or remove focal objects. No text, letters, numbers, readable runes, logo, watermark, signature, card frame, or UI.
```
