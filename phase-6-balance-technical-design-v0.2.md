...
版本：0.2 设计稿
状态：B06 已改用每回合基础 10 金币尽量刷新、只使用刷新赋予法术的五回合路线，fixture v0.3 更新为 N 88/100、H 215/239；`R10-sky-hoof-unity` 完整 S0 已通过，待以 R12 夹具复跑 S0 并处理 B03-H、B01-N 与 B04-H
Unity：2022.3.62f3c1
内容基线：`content-release 5.1.0`，64 个非 Token 随从、3 个 Token、16 张法术
自动化基线：Unity 2022.3.62f3c1 EditMode 121 / 121、PlayMode 14 / 14；`R10-sky-hoof-unity` 8,400 场 S0 首跑与同种子复跑通过
...
| `B02_BREAK` | 失盾反击 | 失盾成长、反击爆发 | 61/49 | 111/78 | 失盾次数、临时/永久成长、首轮爆发 |
| `B03_SUMMON` | 频率召唤 | 嵌套亡语、立即攻击 | 44/50 | 73/80 | 成功/失败召唤、立即攻击、非 Token 核心存活 |
| `B04_DEATH` | 亡语成长 | 非 Token 死亡、残局成长 | 75/86 | 124/163 | 非 Token 死亡、永久差量、残局核心 |
| `B05_SPELL` | 法术回响 | 施法成长、下一战强化 | 83/81 | 151/142 | 法术投入、首轮输出、稳定性 |
| `B06_REFRESH` | 经济刷新 | 刷新里程碑、金币与护盾 | 88/100 | 215/239 | 有效刷新、免费刷新、金币净收益、下一战护盾 |
...
| `B02_BREAK` | 0 | `oathbroken_blade_soul` | 断誓刃魂 | +3/+3 | +9/+4 | 11/8 | 25/14 |
| `B02_BREAK` | 1 | `molten_core_standard` | 熔核执旗手 | +4/+3 | +10/+8 | 7/7 | 16/16 |
| `B02_BREAK` | 2 | `undying_furnace_king` | 不熄炉王 | +9/+6 | +15/+4 | 15/14 | 27/20 |
| `B02_BREAK` | 3 | `counterflow_smith` | 逆流铸师 | +9/+0 | +11/+1 | 12/4 | 17/9 |
| `B02_BREAK` | 4 | `cinder_armor_arbiter` | 烬甲裁决者 | +10/+11 | +14/+9 | 16/16 | 26/19 |
| `B03_SUMMON` | 0 | `hundred_song_herd` | 百鸣兽群 | +1/+1 | +3/+4 | 5/5 | 11/12 |
| `B03_SUMMON` | 1 | `fox_den_matriarch` | 狐群巢母 | +1/+1 | +3/+4 | 5/6 | 11/14 |
| `B03_SUMMON` | 2 | `many_branch_invoker` | 群枝唤灵者 | +7/+14 | +10/+11 | 9/18 | 14/19 |
| `B03_SUMMON` | 3 | `vinecrown_priest` | 藤冠祭司 | +3/+4 | +2/+3 | 6/10 | 8/15 |
| `B03_SUMMON` | 4 | `ten_thousand_hoof_surge` | 万蹄奔潮 | +12/+3 | +15/+4 | 19/11 | 29/20 |
| `B04_DEATH` | 0 | `rootbound_soul_guide` | 归根引魂者 | +6/+5 | +2/+3 | 9/10 | 8/13 |
| `B04_DEATH` | 1 | `ancient_moss_hatchling` | 古苔巨幼体 | +6/+9 | +15/+16 | 9/14 | 21/26 |
| `B04_DEATH` | 2 | `mountain_belly_soul_eater` | 山腹吞灵者 | +9/+9 | +16/+22 | 14/15 | 26/34 |
| `B04_DEATH` | 3 | `ancient_mountain_spirit` | 群山古灵 | +11/+15 | +17/+15 | 17/24 | 29/33 |
| `B04_DEATH` | 4 | `world_eating_final_bloom` | 终花吞世者 | +22/+11 | +32/+33 | 26/23 | 40/57 |
...
| `B06_REFRESH` | 0 | `astrolabe_calibrator` | 星盘校准师 | +17/+17 | +38/+38 | 19/19 | 42/42 |
| `B06_REFRESH` | 1 | `fate_track_recorder` | 命轨记录员 | +15/+15 | +39/+39 | 17/20 | 43/49 |
| `B06_REFRESH` | 2 | `moonwheel_dispatcher` | 月轮调度者 | +13/+13 | +37/+37 | 16/19 | 43/49 |
| `B06_REFRESH` | 3 | `star_ring_treasurer` | 星环司库 | +15/+15 | +37/+37 | 19/21 | 45/49 |
| `B06_REFRESH` | 4 | `sky_covenant_bearer` | 天穹契约者 | +13/+13 | +34/+34 | 17/21 | 42/50 |
...
| `B03_SUMMON` | 每回合使用 3 张固定成长法术；第 1/3/5 回合压力战 | 同 N | Token 由实际亡语产生，不预放；N/H 分别以 7/12 层繁茂开战 |
...
- `B03_SUMMON` 的繁茂是构筑级玩家状态，R9 代表快照为 N 7 层、H 12 层；这只是开战层数而不是上限，战中仍可继续增长；
...
- `B06_REFRESH`：第 2/3/4/5 次刷新里程碑只触发配置允许的次数；天穹在第 4/8/12…次刷新重复触发；免费刷新和金币收益不会自我生成无限循环。
