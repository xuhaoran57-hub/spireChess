...
### 6.17 R17 内容 5.3.1 Unity S0（2026-07-20）

- 内容 5.3.1 基线为提交 `76a0640dd69c`、配置哈希 `df8034664c76abe03a9aa9ad024da7ebcb57f9addcf5948e53308e8c50b6622c`，fixture 0.3.0、核心分类器 0.2.2；
- Unity 2022.3.62f3c1 全量自动化通过 EditMode 197 / 197、PlayMode 18 / 18；疾羽林隼、腐叶承嗣及金色星图掮客、旧塔向导、星门讲师的两轮发现均完成人工验收；
- Unity S0 完成 8,400 场首跑和 8,400 场同种子复跑；确定性失败、异常、效果上限、竞技回合上限和输出木桩回合上限均为 0；
- 30 组镜像对局中 9 组越过 25%-75% 触发线，15 组进入 35%-65% 目标带；
- 等权得分率为 B01 N/H 69.15%/53.70%，B02 47.00%/33.85%，B03 49.30%/33.05%，B04 39.30%/74.00%，B05 45.95%/46.00%，B06 49.30%/59.40%，胜负、回合、首轮输出和存活数均与 R16 相同；
- 唯一汇总差异为山腹吞灵者战后成长带来的 B04 永久差量上升：输出木桩 N `1 → 3`、H `2 → 6`，镜像对局单组平均增量 N 为 0.01-0.15、H 为 0.14-0.32，不影响本轮战斗结果；
- 当前静态 B03/B04 终局夹具不含两张 2 级荒灵，因此疾羽林隼和腐叶承嗣的获取率、早期战斗价值及成型贡献仍须由 S2 人工单局和第 10 回合样本验证；
- 完整记录见 `balance-results/phase-6-v0.3/R17-content-5.3.1-unity/R17-content-5.3.1-S0-report.md`。
