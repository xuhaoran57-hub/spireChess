...
{
    public static class LightStorybookProductionBatch2Builder
    {
        ...
        private const string BatchId = "batch-02-tier2";
        ...
        public static void Build()
        {
            ...
            Debug.Log(
                "[LightStorybook] Built isolated v0.3.3 Batch 02 " +
                "catalog with eleven tier-2 minions.");
        }
        ...
        private static ProductionItem[] LoadAndValidateSpecs()
        {
                    ...
                    string.IsNullOrWhiteSpace(value.Sha256)))
            {
                throw new InvalidOperationException(
                    "Batch 02 requires eleven generated tier-2 minions " +
            ...
            {
                throw new InvalidOperationException(
                    "Batch 02 ids and art ids must be unique.");
            }
            ...
            foreach (var expected in ExpectedRaceCounts)
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Batch 02 requires {expected.Value} " +
        ...
        private static void ValidateAgainstConfig(ProductionItem[] specs)
        {
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 02 minion is missing: " + spec.Id);
                }
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 02 manifest drifted from config: " +
                        spec.Id);
                }
            }
        }
            ...
            ProductionItem[] specs)
        {
            ...
            for (var index = 0; index < specs.Length; index++)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 02 artwork hash drifted: " + spec.Id);
                }
            ...
            Sprite[] sprites)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Failed to create Batch 02 isolated catalog.");
            }
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 02 catalog has no exact artwork for " +
                        spec.ArtId);
                }
            }
        }
