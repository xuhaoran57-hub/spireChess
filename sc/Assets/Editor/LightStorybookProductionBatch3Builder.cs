...
{
    public static class LightStorybookProductionBatch3Builder
    {
        ...
        private const string BatchId = "batch-03-tier3";
        ...
        public static void Build()
        {
            ...
            Debug.Log(
                "[LightStorybook] Built isolated v0.3.3 Batch 03 " +
                "catalog with seven tier-3 minions.");
        }
        ...
        private static ProductionItem[] LoadAndValidateSpecs()
        {
                    ...
                    string.IsNullOrWhiteSpace(value.Sha256)))
            {
                throw new InvalidOperationException(
                    "Batch 03 requires seven generated tier-3 minions " +
            ...
            {
                throw new InvalidOperationException(
                    "Batch 03 ids and art ids must be unique.");
            }
            ...
            foreach (var expected in ExpectedRaceCounts)
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Batch 03 requires {expected.Value} " +
        ...
        private static void ValidateAgainstConfig(ProductionItem[] specs)
        {
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 03 minion is missing: " + spec.Id);
                }
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 03 manifest drifted from config: " +
                        spec.Id);
                }
            }
        }
            ...
            ProductionItem[] specs)
        {
            ...
            for (var index = 0; index < specs.Length; index++)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 03 artwork hash drifted: " + spec.Id);
                }
            ...
            Sprite[] sprites)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Failed to create Batch 03 isolated catalog.");
            }
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 03 catalog has no exact artwork for " +
                        spec.ArtId);
                }
            }
        }
