...
{
    public static class LightStorybookProductionBatch1Builder
    {
        public const string CatalogPath =
            "Assets/Configs/Presentation/" +
            "PresentationSpriteCatalog_LightStorybookProductionV033Batch01.asset";
        ...
        private const string BatchId = "batch-01-tier1";
        ...
        public static void Build()
        {
            ...
            Debug.Log(
                "[LightStorybook] Built isolated v0.3.3 Batch 01 " +
                "catalog with seven tier-1 minions.");
        }
        ...
        private static ProductionItem[] LoadAndValidateSpecs()
        {
                    ...
                    string.IsNullOrWhiteSpace(value.Sha256)))
            {
                throw new InvalidOperationException(
                    "Batch 01 requires seven generated tier-1 minions " +
            ...
            {
                throw new InvalidOperationException(
                    "Batch 01 ids and art ids must be unique.");
            }
            ...
            foreach (var expected in ExpectedRaceCounts)
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Batch 01 requires {expected.Value} " +
        ...
        private static void ValidateAgainstConfig(ProductionItem[] specs)
        {
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 01 minion is missing: " + spec.Id);
                }
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 01 manifest drifted from config: " +
                        spec.Id);
                }
            }
        }
            ...
            ProductionItem[] specs)
        {
            ...
            for (var index = 0; index < specs.Length; index++)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 01 artwork hash drifted: " + spec.Id);
                }
            ...
            Sprite[] sprites)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Failed to create Batch 01 isolated catalog.");
            }
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 01 catalog has no exact artwork for " +
                        spec.ArtId);
                }
            }
        }
