...
{
    public static class LightStorybookProductionBatch5Builder
    {
        public const string CatalogPath =
            "Assets/Configs/Presentation/" +
            "PresentationSpriteCatalog_LightStorybookProductionV033Batch05.asset";
        ...
        private const string BatchId = "batch-05-tier5";
        ...
        public static void Build()
        {
            ...
            Debug.Log(
                "[LightStorybook] Built isolated v0.3.3 Batch 05 " +
                "catalog with six tier-5 minions.");
        }
        ...
        private static ProductionItem[] LoadAndValidateSpecs()
        {
                    ...
                    string.IsNullOrWhiteSpace(value.Sha256)))
            {
                throw new InvalidOperationException(
                    "Batch 05 requires six generated tier-5 minions " +
            ...
            {
                throw new InvalidOperationException(
                    "Batch 05 ids and art ids must be unique.");
            }
            ...
            foreach (var expected in ExpectedRaceCounts)
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Batch 05 requires {expected.Value} " +
        ...
        private static void ValidateAgainstConfig(ProductionItem[] specs)
        {
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 05 minion is missing: " + spec.Id);
                }
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 05 manifest drifted from config: " +
                        spec.Id);
                }
            }
        }
            ...
            ProductionItem[] specs)
        {
            ...
            for (var index = 0; index < specs.Length; index++)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 05 artwork hash drifted: " + spec.Id);
                }
            ...
            Sprite[] sprites)
        {
            ...
            {
                throw new InvalidOperationException(
                    "Failed to create Batch 05 isolated catalog.");
            }
            ...
            foreach (var spec in specs)
            {
                ...
                {
                    throw new InvalidOperationException(
                        "Batch 05 catalog has no exact artwork for " +
                        spec.ArtId);
                }
            }
        }
