    ...
    public sealed class RunPhaseFourCTests
    {
        ...
        public void ReleasedEncounterCurve_MatchesChapterStatTargets()
        {
            ...
            var expected = new Dictionary<string, int[]>
            {
                ...
                ["f2_opening_encounter"] = new[] { 23, 36 },
                ["f2_normal_encounter"] = new[] { 29, 49 },
                ["f2_event_ambush_encounter"] = new[] { 20, 24 },
                ["f2_elite_encounter"] = new[] { 20, 26 },
                ["f2_mid_mechanic_encounter"] = new[] { 30, 59 },
                ...
                ["f1_early_summon_encounter"] = new[] { 4, 5 },
                ["f1_route_normal_encounter"] = new[] { 9, 12 },
                ["f1_route_safe_encounter"] = new[] { 7, 13 },
                ["f1_c4_elite_encounter"] = new[] { 11, 12 },
                ["f1_c5_shield_encounter"] = new[] { 15, 18 },
                ["f1_c5_summon_encounter"] = new[] { 13, 18 },
                ["f1_c6_boss_encounter"] = new[] { 13, 23 },
                ["f1_c4_event_ambush_encounter"] = new[] { 9, 10 },
                ["f2_early_spell_encounter"] = new[] { 30, 40 },
                ["f2_route_normal_encounter"] = new[] { 32, 66 },
                ["f2_route_safe_encounter"] = new[] { 36, 86 },
                ["f2_c4_elite_encounter"] = new[] { 35, 62 },
                ["f2_c5_break_encounter"] = new[] { 34, 84 },
                ["f2_c5_spell_encounter"] = new[] { 40, 76 },
                ["f2_c6_boss_encounter"] = new[] { 48, 60 },
                ["f2_c4_event_ambush_encounter"] = new[] { 38, 73 },
                ["f3_early_summon_encounter"] = new[] { 74, 101 },
