...
- 日期：2026-07-22
- 更新：2026-07-31（登记 v0.3.4 Token Refresh 三张新风格候选）
- 状态：G1、G2 已通过并关闭；旧 G2 Token 仍为现行 Runtime；v0.3.4 Token Refresh 三张候选为 `工程样板`，等待负责人视觉/生产使用确认与 Runtime 晋级；G4 五张背景候选仍待负责人生产许可签字；G3 正式 AI 音频仍等待生成、筛选、来源/条款登记、技术门禁与人工听审
...
| `card_token_token_young_spirit_v034_candidate` | —（候选未接入 Runtime） | `e7eecf493dccc2b86bb798e2a9313dc9a0f375934c64b7c6c53808c1bcdd36c1` | `ui-concepts/phase-9c/light-storybook-production-v0.1/token-refresh-v0.3.4/masters/token-young-spirit-v0.3.4.png` | Codex 内置 ImageGen；后端模型版本/种子不可获得；新图生成；唯一图像参考为冻结 Style Tile，仅控制媒介、纸张、配色和曝光；未传入旧 Token 图；完整 Prompt 已留档 | Personal OpenAI services / Terms of Use；`工程样板`；生产使用确认待完成 | 1402×1122；SHA、约 5:4 画幅与亮度门禁通过；人工预审通过；用户视觉批准与 Runtime 复验待完成 |
| `card_token_token_swift_young_spirit_v034_candidate` | —（候选未接入 Runtime） | `ea6ff92d95fa0a1ec149594f62fa32387e43ae8f9fd3f813aed93bc772e5563c` | `ui-concepts/phase-9c/light-storybook-production-v0.1/token-refresh-v0.3.4/masters/token-swift-young-spirit-v0.3.4.png` | Codex 内置 ImageGen；后端模型版本/种子不可获得；新图生成；唯一图像参考为冻结 Style Tile，仅控制媒介、纸张、配色和曝光；未传入旧 Token 图或幼灵输出；完整 Prompt 已留档 | Personal OpenAI services / Terms of Use；`工程样板`；生产使用确认待完成 | 1402×1122；SHA、约 5:4 画幅与亮度门禁通过；人工预审通过；用户视觉批准与 Runtime 复验待完成 |
| `card_token_token_two_tailed_fox_shadow_v034_candidate_r1` | —（候选未接入 Runtime） | `da4896d63c3496bdaebec45f1ba5bbf281ea6e0f2b95feb27d6f97600f7cb736` | `ui-concepts/phase-9c/light-storybook-production-v0.1/token-refresh-v0.3.4/masters/token-two-tailed-fox-shadow-v0.3.4.png` | Codex 内置 ImageGen；后端模型版本/种子不可获得；新图生成；唯一图像参考为冻结 Style Tile；未传入旧 Token 图；完整 Prompt 已留档 | `工程样板（已否决）`；不得晋级 | 2026-07-31 用户指出尾巴位置奇怪；两尾像从肩背长出并围住头部，停止作为候选 |
| `card_token_token_two_tailed_fox_shadow_v034_candidate_r2` | —（候选未接入 Runtime） | `88aef93f35041468a7473628d51a0a2254263dc00d225b509597f6de44126a25` | `ui-concepts/phase-9c/light-storybook-production-v0.1/token-refresh-v0.3.4/masters/token-two-tailed-fox-shadow-v0.3.4-r2.png` | Codex 内置 ImageGen；后端模型版本/种子不可获得；按侧向全身、骨盆双尾根、一低一扫的构图硬约束重新生成；唯一图像参考为冻结 Style Tile；未传入旧 Token 图或 r1；完整 Prompt 已留档 | `工程样板（已否决）`；不得晋级 | 2026-07-31 用户发现腹部下方多出第三条后腿，合计五条腿；停止作为候选 |
| `card_token_token_two_tailed_fox_shadow_v034_candidate_r3` | —（候选未接入 Runtime） | `9d67ff3fdb159c1560c25003a94baeeb9d99beca4ba10ffe2d62001c38f2406f` | `ui-concepts/phase-9c/light-storybook-production-v0.1/token-refresh-v0.3.4/masters/token-two-tailed-fox-shadow-v0.3.4-r3.png` | Codex 内置 ImageGen；后端模型版本/种子不可获得；按平地侧向站姿、逐条四足和骨盆双尾根硬约束重新生成；唯一图像参考为冻结 Style Tile；未传入旧 Token 图、r1 或 r2；完整 Prompt 已留档 | Personal OpenAI services / Terms of Use；`工程样板`；生产使用确认待完成 | 1402×1122；人工逐项复核为前腿 2、后腿 2、爪 4、尾 2、骨盆尾根 2、光点 2；自动门禁通过，用户视觉批准与 Runtime 复验待完成 |
